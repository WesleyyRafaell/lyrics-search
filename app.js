...
const prevAndNexContainer  = document.querySelector('#prev-and-next-container')
...
const insertSongsIntoPage = songsInfo => {
    songsContainer.innerHTML = songsInfo.data.map(({artist, title}) => `
        <li class="song">
...
form.addEventListener('submit', event => {
    ...
    if(!searchTerm){
        songsContainer.innerHTML = `<li class="warning-message">O campo não pode ficar vázio</li>`;
        return;
    }
